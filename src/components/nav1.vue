...
<section class="nav1">
  <nav class="navbar navbar-expand-md navbar-light bg-light">
      ...
      <div id="botones" class="nav-item">
          <button class="btn btn-outline-primary my-2 my-sm-0" @click="abrirModalLogin" type="submit">Login</button>
          <button class="btn btn-outline-primary my-2 my-sm-0" @click="abrirModalRegis" type="submit">Register</button>
      </div>
  </nav>
  <!--Modal Registro-->
